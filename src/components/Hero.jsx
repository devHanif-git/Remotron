      ...
      <section className="flex flex-col sm:flex-row justify-between items-center max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="sm:w-1/2 text-center sm:text-left mb-10 sm:mb-0">
          ...
          <div className="space-y-4 sm:space-x-4 sm:space-y-0 flex flex-col sm:flex-row justify-center sm:justify-start mt-8 sm:mt-0">
            <a href="#our-story">
              <button className="bg-neonBlue text-black py-2 px-4 rounded-lg text-l font-semibold hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-105 w-full sm:w-auto">
                Learn More
              </button>
            </a>
            <a href="#products">
              <button className="border border-neonBlue text-neonBlue py-2 px-4 rounded-lg text-l font-semibold hover:bg-neonBlue hover:text-black transition-all duration-300 transform hover:scale-105 w-full sm:w-auto">
                Explore Products
              </button>
            </a>
          </div>
